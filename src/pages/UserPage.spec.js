...
describe('UserPage', () => {
  ...
  describe('ProfileCard Interactions', () => {
    ...
    it('remove validation error for displayName when user changes the displayName', async () => {
      const { queryByText, container } = await setupForEdit();
      apiCalls.updateUser = jest.fn().mockRejectedValue(mockFailUpdateUser);
    ...
    it('remove validation error for file when user changes the file', async () => {
      const { queryByText, container } = await setupForEdit();
      apiCalls.updateUser = jest.fn().mockRejectedValue(mockFailUpdateUser);
    ...
    it('remove validation error if user cancels', async () => {
      const { queryByText } = await setupForEdit();
      apiCalls.updateUser = jest.fn().mockRejectedValue(mockFailUpdateUser);
